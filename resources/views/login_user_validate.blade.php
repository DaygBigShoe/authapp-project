                    ...
                    if (long !== "" && lat !== "") {
                        $.ajax({
                            ...
                            error: (xhr, _, err) => {
                                ...
                                $("#pin-error").addClass("inline-block");
                                $("#pin-error").html(xhr.responseJSON);
                                console.log("Error:", xhr.responseJSON);
                            }
                        })
                    } else {
                        alert("Location is needed to proceed");
                    }
                });
                ...
                if (navigator.geolocation) {
                    fpPromise
                        ...
                        .then(result => {
                            ...
                            visitorId ? getPin(result.visitorId) : alert("Error disable ad blockers")
                        })
                } else {
